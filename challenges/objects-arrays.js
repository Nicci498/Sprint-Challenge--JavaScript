...
graduates.forEach(function(el) {
  universities.sort().push(el.university)
})
...
const unisWithUni = graduates.filter(function(el) {
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(el) {
